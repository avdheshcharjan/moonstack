...
export default function Home() {
  ...
  // Retro sound effect using Web Audio API
  ...
  return (
    <main className="min-h-screen w-full relative overflow-hidden scan-lines" style={{ fontFamily: "'Pixelify Sans', cursive" }}>
      ...
      <div className="fixed inset-0 z-0">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  {/* Fins */}
                  <div className="absolute bottom-0 -left-4 w-6 h-12 bg-red-500 border-2 border-red-600" style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 100%)' }} />
                  <div className="absolute bottom-0 -right-4 w-6 h-12 bg-red-500 border-2 border-red-600" style={{ clipPath: 'polygon(0 0, 0 100%, 100% 100%)' }} />
                </div>
                ...
                <div className="relative -mt-1">
                  ...
                  <div className="absolute right-2 top-6 w-4 h-8 bg-yellow-400 animate-pulse" style={{ animationDelay: '0.2s' }} />
                  <div className="absolute left-2.5 top-10 w-3 h-6 bg-yellow-200 animate-pulse" style={{ animationDelay: '0.1s' }} />
                  <div className="absolute right-2.5 top-10 w-3 h-6 bg-yellow-200 animate-pulse" style={{ animationDelay: '0.3s' }} />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Animated Gradient Orbs with color shift */}
        ...
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-cyan-500 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-pink-500 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '2s' }} />

        {/* Extra moving gradient for dizzy effect */}
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-yellow-500 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '0.5s' }} />
      </div>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="relative animate-float">
            ...
            <div className="relative bg-black/90 backdrop-blur-xl rounded-3xl p-6 md:p-8 border-4 border-purple-500/50 shadow-2xl shadow-purple-500/50">
              ...
              {/* Featured Action with enhanced glow */}
              <button
      ...
      {/* Floating Pixel Elements - More of them! */}
      {[
        { size: 8, color: 'bg-pink-500', top: '20', left: '10', delay: '0.5s' },
        { size: 6, color: 'bg-cyan-500', top: '40', right: '20', delay: '1s' },
        { size: 10, color: 'bg-purple-500', bottom: '32', left: '20', delay: '1.5s' },
        { size: 8, color: 'bg-yellow-500', bottom: '20', right: '10', delay: '2s' },
        { size: 12, color: 'bg-green-500', top: '60', left: '30', delay: '0.8s' },
        { size: 6, color: 'bg-red-500', top: '30', right: '40', delay: '1.3s' },
        { size: 10, color: 'bg-blue-500', bottom: '50', right: '30', delay: '1.8s' },
        { size: 8, color: 'bg-orange-500', top: '70', left: '50', delay: '2.3s' },
      ].map((pixel, i) => (
        <div
          key={i}
          className={`fixed ${pixel.color} opacity-40 animate-float shadow-lg`}
          style={{
            width: `${pixel.size}px`,
            height: `${pixel.size}px`,
            top: pixel.top ? `${pixel.top}%` : undefined,
            bottom: pixel.bottom ? `${pixel.bottom}%` : undefined,
            left: pixel.left ? `${pixel.left}%` : undefined,
            right: pixel.right ? `${pixel.right}%` : undefined,
